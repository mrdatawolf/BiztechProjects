...
router.post('/', requireAuth, async (req, res) => {
  ...
  try {
    ...
    const result = await db.query(
      `INSERT INTO tasks (phase_id, position, name, assignee, due_date, priority)
       VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
      [phase_id, pos, name, assignee, due_date || null, priority]
    );
...
router.patch('/:id', requireAuth, async (req, res) => {
  ...
  const allowed = ['name', 'assignee', 'due_date', 'priority', 'done'];
